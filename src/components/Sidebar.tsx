...
export default function Sidebar() {
  ...
  return (
    <div className="bg-gradient-to-b from-[#0f172a] to-[#1e3a8a] text-textPrimary w-20 sm:w-56 flex flex-col items-center sm:items-start py-5 px-2 sm:px-4 min-h-screen rounded-bl-2xl">
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-2 rounded-xl transition text-sm font-medium ${
                isActive
                  ...
                  : 'text-textPrimary hover:bg-white/20 hover:shadow'
              }`}
            >
      ...
      <div className="mt-auto w-full">
        <button
          ...
          className="flex items-center gap-3 w-full px-4 py-2 text-textPrimary hover:bg-white/20 hover:shadow rounded-xl transition text-sm font-medium"
        >
