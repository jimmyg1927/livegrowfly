...
export default function Sidebar() {
  ...
  return (
    <div className="bg-[#1992ff] text-white w-20 sm:w-56 flex flex-col items-center sm:items-start py-5 px-2 sm:px-4 min-h-screen rounded-r-2xl">
      ...
      <div className="mt-auto w-full">
        <button
          ...
          className="flex items-center gap-3 w-full px-4 py-2 text-white hover:bg-white/20 rounded-xl transition text-sm font-medium"
        >
